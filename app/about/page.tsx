				...
				<div className="flex flex-col items-center space-y-12">
					...
					>
						<p className="text-lg font-lato text-white">
							DEVBLOG is a software development blog filled with tutorials,
							articles, and interactive features. This project serves as a
							personal <span className="text-purpleContrast">portfolio</span>,
							showcasing my skills in web development and my passion for design
							and functionality.
						</p>
					</div>
					...
					>
						<p className="text-lg font-lato text-white">
							Built using <span className="text-purpleContrast">Next.js</span>,{" "}
							<span className="text-purpleContrast">React.js</span>,{" "}
							<span className="text-purpleContrast">Mongoose</span>,{" "}
							<span className="text-purpleContrast">Tailwind CSS</span>,{" "}
							<span className="text-purpleContrast">p5.js</span>,{" "}
					...
					>
						<p className="text-lg font-lato text-white">
							The site features advanced functionality like tag-based search,
							post recommendations, user interaction tools, and even a{" "}
							<span className="text-purpleContrast">playground</span> with games
							and animations, showcasing my ability to create engaging web
							experiences.
						</p>
					</div>
				</div>
