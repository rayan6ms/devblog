					...
					<div className="flex flex-1 flex-col md:flex-row justify-between items-center">
						<div className="flex-1 md:text-left mb-6 md:mb-0">
							<div className="lg:ml-auto lg:w-3/4">
								<h1 className="text-5xl text-center lg:text-start font-somerton text-purpleContrast ">
									DEVBLOG
								</h1>
						...
						<div className="flex flex-1 justify-center gap-4 font-europa underline text-lg shadow-zinc-600 text-zinc-200">
							<Link
								href="/"
								className="hover:text-purpleContrast text-center transition-colors duration-300"
							>
								Home
							</Link>
							<Link
								href="/about"
								className="hover:text-purpleContrast transition-colors duration-300"
							>
								About
							</Link>
							<Link
