...
function TopicPill({ label, count }: { label: string; count: number }) {
	return (
		<LocalizedLink
			...
			className="flex items-center justify-between rounded-2xl border border-zinc-700/50 bg-greyBg/80 px-4 py-3 text-sm font-semibold text-zinc-300 transition-colors hover:border-zinc-500 hover:text-wheat"
		>
...
export default function TrendingPageClient({ posts }: { posts: IPost[] }) {
