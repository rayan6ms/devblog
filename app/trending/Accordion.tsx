					...
					>
						<Image
							...
							className={`object-cover transition-[filter,transform] duration-700 ${
								isActive
									? "scale-100 brightness-[0.74]"
									: "scale-105 brightness-[0.80]"
							}`}
							sizes="(max-width: 960px) 100vw, 30vw"
						/>
						<div
							className={`absolute inset-0 bg-gradient-to-t from-darkBg/95 via-darkBg/65 to-darkBg/5 transition-opacity duration-500 ${
						...
						<div className="relative z-10 h-full p-5">
							<div
								className={`absolute top-5 z-20 flex items-center transition-all duration-500 ${
									isActive
							...
							>
								...
								<LocalizedLink
									...
									className={`inline-flex w-fit overflow-hidden rounded-full border bg-black/35 text-xs uppercase tracking-[0.16em] text-zinc-100 transition-all duration-500 hover:border-zinc-300 hover:text-wheat ${
										isActive
							...
							<div
								className={`absolute right-5 top-5 z-20 text-right transition-all duration-300 ${
									isActive
							...
							<div
								className={`absolute inset-x-5 bottom-5 transition-all duration-500 ${
									isActive
										? "translate-y-0 opacity-100"
