	...
	return (
		...
		>
			...
			>
				...
				<div
					className={`absolute top-2 right-2 rounded-full border border-white/15 px-2 py-0.5 text-[10px] uppercase tracking-wide text-white ${badge.cls}`}
				>
					{badge.text}
				</div>
			</div>
...
const Playground: React.FC = () => {
	...
	return (
		<>
			...
			>
				<h1 className="text-5xl font-somerton pt-6 w-full text-center">
					GAMES
				</h1>
